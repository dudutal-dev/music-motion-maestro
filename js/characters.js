...
(function (global) {
  ...
  /* ============================================================
     ...
     ============================================================ */
  const SHOT_TIERS = [
    { id: 'macro', he: 'מאקרו — היד בגדול',
      note: 'רק היד והצוואר בפריים. הכי קרוב לאצבוע נכון; הפנים לא נראים.' },
    { id: 'balanced', he: 'מאוזן — חצי גוף',
      note: 'הדמות מזוהה והיד בחזית וקרובה. ברירת המחדל לפוסטר.' },
    { id: 'wide', he: 'רחב — סצנה מלאה',
      note: 'הכי יפה. היד קטנה בפריים ולכן מקורבת — מתאים כשהאווירה חשובה ' +
        'יותר מהאצבוע המדויק.' }
  ];
